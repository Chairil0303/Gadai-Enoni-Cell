@extends('layouts.app')
    ...
    <div class="bg-white py-2 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <h2 class="text-base/7 font-semibold text-green-600">Deploy faster</h2>
                <p class="mt-2 text-4xl text-green-600 font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance">Enoni Cell Gadai</p>
                <p class="mt-6 text-lg/8 text-gray-600">
                    Cabang: {{ auth()->user()->cabang->nama_cabang ?? 'Cabang tidak ditemukan' }}, 
                    {{ auth()->user()->cabang->alamat ?? 'Alamat tidak tersedia' }}<br>
                    Telepon: {{ auth()->user()->cabang->kontak ?? 'Nomor tidak tersedia' }}
                </p>
                </div>
