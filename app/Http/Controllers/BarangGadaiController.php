    ...
    public function store(Request $request)
{
    ...
    // Cari data bunga tenor
    $bungaTenor = BungaTenor::where('tenor', $request->tenor)->first();

    if (!$bungaTenor) {
        return back()->withErrors(['tenor' => 'Data bunga untuk tenor ini tidak ditemukan.']);
    }
    ...
    BarangGadai::create([
        ...
        'imei'         => $request->imei,
        'tenor'        => $request->tenor,
        'bunga'        => $bungaTenor->bunga_percent, // sekarang sudah aman
        'tempo'        => $tempo,
        'telat'        => 0,
